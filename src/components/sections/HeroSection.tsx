    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center space-y-6">
          <h2 
            className="text-xl md:text-2xl text-crystal-primary font-medium tracking-wider uppercase opacity-0 animate-fadeIn"
            style={{ animationDelay: "0.2s", animationFillMode: "forwards" }}
          >
            {t('welcomeTo')}
          </h2>
          <h1 
            className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 opacity-0 animate-fadeIn leading-tight"
          ...
          <p 
            className="text-xl md:text-2xl lg:text-3xl text-white/90 max-w-3xl mx-auto mb-12 opacity-0 animate-fadeIn leading-relaxed"
